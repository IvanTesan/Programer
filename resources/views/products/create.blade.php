...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        <h1 class="text-4xl font-extrabold text-blue-500" style="text-shadow:0 0 10px #0056ff">Crear Nuevo Curso</h1>
        <a href="{{ route('products.index') }}" class="btn btn-ghost btn-sm">← Volver</a>
    </div>
    ...
    <form id="courseForm" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-2xl p-8 mb-6 shadow-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="form-control">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Ej: Python Máster"
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="tag" value="{{ old('tag') }}" placeholder="Ej: PYTHON"
                ...
                <div class="form-control">
                    ...
                    <select name="gradient" class="select select-bordered bg-gray-900 text-white w-full">
                        @php
                            $currentGradient = old('gradient', 'from-blue-500 to-indigo-600');
                            $knownGradients = [
        ...
        <div class="flex justify-end">
            <button type="submit" class="btn btn-primary btn-lg px-14 text-base shadow-lg shadow-blue-500/20">
                ✅ Crear Curso
            </button>
        </div>
